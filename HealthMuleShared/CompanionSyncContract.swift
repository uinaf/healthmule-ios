...
public enum CompanionPayloadCodec {
    public static let snapshotKey = "healthMuleSnapshot"
    public static let syncRequestKey = "healthMuleSyncRequest"
    public static let acceptedKey = "healthMuleAccepted"
